...
CREATE TABLE IF NOT EXISTS `loans`(
    ...
    `loan_amount` DECIMAL(19, 3) NOT NULL,
    `paid_loan_amount` DECIMAL(19, 3) NOT NULL DEFAULT 0,
    `contract_number` VARCHAR(255) NOT NULL UNIQUE,
    `interest_rate` DECIMAL(5, 2) NOT NULL DEFAULT '0',
    `interest_amount` DECIMAL(19, 3) NOT NULL DEFAULT 0,
    `paid_interest_amount` DECIMAL(19, 3) NOT NULL DEFAULT 0,
